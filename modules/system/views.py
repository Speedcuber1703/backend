...
class UserConfirmEmailView(View):
    """
    Представление подтверждение email
    """
...
class EmailConfirmationSentView(TemplateView):
    """
    Представление отправленного письма активации
    """
...
class EmailConfirmedView(TemplateView):
    """
    Представление успешной активации email
    """
...
class EmailConfirmationFailedView(TemplateView):
    """
    Представление провальной активации email
    """
...
def tr_handler403(request, exception):
    ...
    return render(request=request, template_name='system/errors/error_page.html',
                  status=403, context={
...
def tr_handler404(request, exception):
    ...
    return render(request=request, template_name='system/errors/error_page.html',
                  status=404, context={
                      ...
                      'error_message': 'К сожалению, такая страница не найдена, возможно, она была перемещена'
                  })
...
def tr_handler500(request):
    ...
    return render(request=request, template_name='system/errors/error_page.html',
                  status=500, context={
                      ...
                      'error_message': 'Внутренняя ошибка сайта, вернитесь на главную страницу, отчёт об ошибки мы направим администрации сайта'
                  })

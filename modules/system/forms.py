...
class UserRegisterForm(UserCreationForm):
    """
    Переопределённая форма регистрации пользователей
    """
...
class UserLoginForm(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            self.fields['username'].widget.attrs.update({'placeholder': 'Логин пользователя'})
            self.fields['password'].widget.attrs.update({'placeholder': 'Пароль пользователя'})

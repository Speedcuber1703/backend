...
from .views import ArticleListView, articles_list, ArticleByCategoryListView, \
    ArticleDetailView, ArticleCreateView, ArticleUpdateView, ArticleDeleteView, \
    CommentCreateView, ArticleByTagListView, ArticleSearchResultView, RatingCreateView, \
    ArticleBySignedUser

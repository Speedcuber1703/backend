...
class Article(models.Model):
    ...
    short_description = CKEditor5Field(verbose_name='Короткое описание', max_length=300, config_name='extends')
...
class Comment(MPTTModel):
    """
    Модель деревовидных комментариев
    """
